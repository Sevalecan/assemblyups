...
---@return table<string, RocketLandingPadInfo> grouped_landing_pads
...
function Landingpad.on_init(event)
  ---Table of all landing pad data objects, indexed by `unit_number` property
  ---@type table<uint, RocketLandingPadInfo>
