...
local water_well_item = {
    icon = "__void-miners__/graphics/icons/water-well.png",
    icon_size = 32,--64
...
local water_well_entity = {
	...
	animation = {
		filename = "__void-miners__/graphics/entity/water-well/water-well.png",
		priority = "high",
		height = 64,
		width = 64,
		frame_count = 1,
	...
	working_sound = {filename = "__void-miners__/sound/water-well-working.ogg", volume = 0.25},
