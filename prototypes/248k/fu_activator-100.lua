...
data:extend({
    {
        name = 'fu_activator_itemx100',
        type = 'item',
        icon = sprite('item.png'),
        icon_size = 64,
        place_result = 'fu_activator_entityx100',
        stack_size = 20,
        subgroup = 'fu_item_subgroup_c',
        order = 'a-a',
    },
    {
        name = 'fu_activator_recipex100',
        type = 'recipe',
        enabled = true,
        ingredients = {
            {type="item", name="fu_activator_itemx10", amount=10},
        },
        result = 'fu_activator_itemx100',
        result_count = 1,
        energy_required = 10,
    },
...
data:extend({
    --prototype
    {
        ...
        crafting_categories = {'fu_activator_crafting_categoryx100'},
        crafting_speed = 1,
        energy_source = {
            type = 'electric',
