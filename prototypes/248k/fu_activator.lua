...
data:extend({
    {
        name = 'fu_activator_itemx10',
        type = 'item',
        icon = sprite('item.png'),
        icon_size = 64,
        place_result = 'fu_activator_entityx10',
        stack_size = 20,
        subgroup = "machine_c",
        order = "c",
    },
    {
        name = 'fu_activator_recipex10',
        type = 'recipe',
        enabled = true,
        ingredients = {
            {type="item", name="fu_activator_item", amount=10},
        },
        result = 'fu_activator_itemx10',
        result_count = 1,
        energy_required = 10,
    },
...
data:extend({
    --prototype
    {
        ...
        crafting_categories = {'fu_activator_crafting_categoryx10'},
        crafting_speed = 1,
        energy_source = {
            type = 'electric',
