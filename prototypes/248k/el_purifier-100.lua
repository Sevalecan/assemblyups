...
data:extend({
    {
        name = 'el_purifier_itemx100',
        type = 'item',
        icon = sprite('icon.png'),
        icon_size = 64,
        place_result = 'el_purifier_entityx100',
        stack_size = 20,
        subgroup = "machine_c",
        order = "e",
    },
    {
        name = 'el_purifier_recipex100',
        type = 'recipe',
        enabled = true,
        category = 'crafting',
        ingredients = {
            {'el_purifier_itemx10',10},
        },
        result = 'el_purifier_itemx100',
        result_count = 1,
        energy_required = 4,
    },
...
data:extend({
  --prototype
  {
      ...
      crafting_categories = {'el_purifier_categoryx100'},
      crafting_speed = 1,
      ingredient_count = 2,
