...
data:extend({
  {
      name = 'el_grower_itemx100',
      type = 'item',
      icon = sprite('icon.png'),
      icon_size = 64,
      place_result = 'el_grower_entityx100',
      stack_size = 20,
      subgroup = "machine_c",
      order = "c",
  },
  {
        name = 'el_grower_recipex100',
        type = 'recipe',
        enabled = true,
        category = 'crafting',
        ingredients = {
            {'el_grower_itemx10',10},
        },
        result = 'el_grower_itemx100',
        result_count = 1,
        energy_required = 4,
    },
...
--prototype
{
    ...
    crafting_categories = {'el_grower_categoryx100'},
    crafting_speed = 1,
    ingredient_count = 3,
