...
data:extend(
{
  ...
  {
    type = "recipe",
    name = "advanced-oil-processing-x500",
    category = "Fluids-x500",
    enabled = true,
    hide_from_player_crafting = true,
    energy_required = 5,
...

  {
    ...
    results=
    {
      {type="fluid", name="high-pressure-light-oil", amount=150}
    },
    main_product= "",
...

  {
    ...
    ingredients =
    {
      {type="item", name="sulfur", amount=2500},
      {type="item", name="iron-plate", amount=5000},
      {type="fluid", name="high-pressure-water", amount=75}
    },
    results=
    {
  ...
  {
    type = "recipe",
    name = "solid-fuel-from-light-oil-x500",
    category = "chemistry-500",
    energy_required = 2,
    ingredients =
    {
  ...
  {
    type = "recipe",
    name = "solid-fuel-from-petroleum-gas-x500",
    category = "chemistry-500",
    energy_required = 2,
    ingredients =
    {
  ...
  {
    type = "recipe",
    name = "solid-fuel-from-heavy-oil-x500",
    category = "chemistry-500",
    energy_required = 2,
    ingredients =
    {
...

  {
    ...
    ingredients =
    {
      ...
      {type="fluid", name="high-pressure-petroleum-gas", amount=150}
    },
    results=
    {
...

  {
    ...
    ingredients =
    {
      {type="fluid", name="high-pressure-heavy-oil", amount=50}
    },
    results=
    {
      {type="fluid", name="high-pressure-lubricant", amount=50}
    },
    subgroup = "fluid-recipes",
    crafting_machine_tint =
    {
