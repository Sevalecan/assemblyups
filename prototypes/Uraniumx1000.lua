...
(
{
  {
    type = "recipe",
    name = "uranium-processing-X1000",
    energy_required = 20,
    enabled = true,
    hide_from_player_crafting = true,
    category = "centrifugingX1000",
    ingredients = {{"uranium-ore", 9975}},
  ...
  {
    type = "recipe",
    name = "kovarex-enrichment-process-X1000",
    energy_required = 90,
    enabled = true,
    hide_from_player_crafting = true,
    category = "centrifugingX1000",
    ingredients = {{"uranium-235", 39975}, {"uranium-238", 4950}},
    icon = "__base__/graphics/icons/kovarex-enrichment-process.png",
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "intermediate-product",
    order = "r[uranium-processing]-c[kovarex-enrichment-process]",
    main_product = "",
    results = {{"uranium-235", 41075}, {"uranium-238", 2075}},
    allow_decomposition = false
  },
  {
    type = "recipe",
    name = "nuclear-fuel-reprocessing-X1000",
    energy_required = 90,
    enabled = true,
    hide_from_player_crafting = true,
    category = "centrifugingX1000",
    ingredients = {{"used-up-uranium-fuel-cell", 1000}},
    icon = "__base__/graphics/icons/nuclear-fuel-reprocessing.png",
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "intermediate-product",
    order = "r[uranium-processing]-b[nuclear-fuel-reprocessing]",
    main_product = "",
    results = {{"uranium-238", 600}},
    allow_decomposition = false
  },
  {
    type = "recipe",
    name = "uranium-fuel-cell-X1000",
    energy_required = 50,
    enabled = true,
    hide_from_player_crafting = true,
    ingredients =
  ...
  {
    type = "item",
    name = "centrifugeX1000",
    icon = "__base__/graphics/icons/centrifuge.png",
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "production-machine",
    order = "g[centrifuge]",
    place_result = "centrifugeX1000",
    stack_size = 50
  },
...

  {
    ...
    minable = {mining_time = 0.1, result = "centrifugeX1000"},
    max_health = 350,
   ...
   -- open_sound = sounds.machine_open,
    ...
    crafting_speed = 5,
    crafting_categories = {"centrifugingX1000"},
    energy_source =
    {
      type = "electric",
