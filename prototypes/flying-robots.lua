...
robot_animations.logistic_robot2 =
{
  idle =
  {
...
{
  {
    type = "construction-robot2",
    name = "construction-robot2",
  ...
  {
    type = "logistic-robot2",
    name = "logistic-robot2",
    icon = "__base__/graphics/icons/logistic-robot.png",
    icon_size = 64, icon_mipmaps = 4,
    flags = {"placeable-player", "player-creation", "placeable-off-grid", "not-on-map"},
    minable = {mining_time = 0.1, result = "logistic-robot2"},
    resistances =
    {
      {
        type = "fire",
  ...
  prototype.destroy_action =
  {
    ...
    },
    {
        ...
        },
        {
            ...
            place_result = "construction-robot2",
            stack_size = 50
        },
    },
  }
