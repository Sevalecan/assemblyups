--FALLBACKS
	--CIRCUITS
	angelsmods.functions.RB.set_fallback("item", "t0-circuit", { { "block-electronics-0" }, { "basic-circuit-board" }, { "electronic-circuit" } })
	angelsmods.functions.RB.set_fallback("item", "t1-circuit", { { "block-electronics-1" }, { "electronic-circuit" }, { "electronic-circuit" } })
	angelsmods.functions.RB.set_fallback("item", "t2-circuit", { { "block-electronics-2" }, { "electronic-circuit" }, { "electronic-circuit" } })
	angelsmods.functions.RB.set_fallback("item", "t3-circuit", { { "block-electronics-3" }, { "advanced-circuit" }, { "advanced-circuit" } })
	angelsmods.functions.RB.set_fallback("item", "t4-circuit", { { "block-electronics-4" }, { "processing-unit" }, { "advanced-circuit" } })
	angelsmods.functions.RB.set_fallback("item", "t5-circuit", { { "block-electronics-5" }, { "advanced-processing-unit" }, { "processing-unit" } })
	...
	angelsmods.functions.RB.set_fallback("item", "t5-brick", { { "block-construction-5" }, { "reinforced-concrete-brick", 5 }, { "stone-brick", 5 } })
	...
	angelsmods.functions.RB.set_fallback("item", "oreelectro-2", { { "block-mprocessing-4", 3 }, { "electro-whinning-cell" } } )
	angelsmods.functions.RB.set_fallback("item", "oreelectro-3", { { "block-mprocessing-5", 3 }, { "electro-whinning-cell-2" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "advchem-2", { { "block-cprocessing-4", 3 }, { "advanced-chemical-plant" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "electrol-3", { { "block-cprocessing-3", 3 }, { "angels-electrolyser-2" } } )
	angelsmods.functions.RB.set_fallback("item", "electrol-4", { { "block-cprocessing-4", 3 }, { "angels-electrolyser-3" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "orepro-3", { { "block-mprocessing-3", 1 }, { "ore-processing-machine-2" } } )
	angelsmods.functions.RB.set_fallback("item", "orepro-4", { { "block-mprocessing-4", 1 }, { "ore-processing-machine-3" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "strandcast-3", { { "block-mprocessing-4", 3 }, { "strand-casting-machine-2" } } )
	angelsmods.functions.RB.set_fallback("item", "strandcast-4", { { "block-mprocessing-5", 3 }, { "strand-casting-machine-3" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "hatch-1", { { "block-production-1", 1 } } )
