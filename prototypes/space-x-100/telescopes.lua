...
local telescope_target_animation_speed = 0.0001
local telescope_crafting_speed = 2
local telescope_module_slots = 4
local telescope_animation_speed = 0.0001
...
data:extend({
  {
    ...
    minable = {mining_time = 0.1, result = "space-telescopex10"},
    max_health = 500,
    corpse = "big-remnants",
    ...
    crafting_categories = {"space-observation-visiblex10", "space-observation-uvx10", "space-observation-infraredx10"},
