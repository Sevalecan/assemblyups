...
data:extend({
  {
    ...
    minable = {mining_time = 0.2, result = "space-laser-laboratoryx100"},
    max_health = 1200,
    corpse = "big-remnants",
    ...
    crafting_categories = {"space-laserx100"},
  ...
  },
  {
    ...
    se_allow_in_space = true,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "space-radiation-laboratoryx100"},
    max_health = 1200,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    alert_icon_shift = util.by_pixel(0, -12),
    ...
    crafting_categories = {"space-radiationx100", "centrifuging"},
