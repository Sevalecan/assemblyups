...
data:extend({
  ...
  },
  {
    ...
    energy_required = 30,
    ingredients = {
      {name = data_util.mod_prefix .. "pulveriser", amount=10},
    },
    results=
    {
      {name = "pulveriserx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-decontamination-facilityx10",
    category = "crafting",
    energy_required = 10,
    ingredients = {
      {name = data_util.mod_prefix .. "space-decontamination-facility", amount=10}
    },
    results=
    {
      {name = "space-decontamination-facilityx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-electromagnetics-laboratoryx10",
    category = "crafting",
    energy_required = 10,
    ingredients = 
    {
      {"se-space-electromagnetics-laboratory", 10},
    },
    results=
    {
      {name = "space-electromagnetics-laboratoryx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-hypercoolerx10",
    category = "space-manufacturing",
    energy_required = 10,
    ingredients = {
      {name = data_util.mod_prefix .. "space-hypercooler", amount=10}
    },
    results=
    {
      {name = "space-hypercoolerx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-laser-laboratoryx10",
    category = "crafting",
    energy_required = 10,
    ingredients = {
      {"se-space-laser-laboratory", 10},
    },
    results=
    {
      {name = "space-laser-laboratoryx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-plasma-generatorx10",
    category = "crafting",
    energy_required = 10,
    ingredients = {
      {name = data_util.mod_prefix .. "space-plasma-generator", amount=10},
    },
    results=
    {
      {name = "space-plasma-generatorx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-radiation-laboratoryx10",
    category = "crafting",
    energy_required = 10,
    ingredients = {
      {name = data_util.mod_prefix .. "space-radiation-laboratory", amount=10},
    },
    results=
    {
      {name = "space-radiation-laboratoryx10", amount=1}
    },
  ...
  {
    type = "recipe",
    name = "space-telescopex10",
    category = "space-manufacturing",
    energy_required = 10,
    ingredients = {
      {name = "se-space-telescope", amount=10},
    },
    results=
    {
      {name = "space-telescopex10", amount=1}
    },
