...
make_recipe({
  name = "radiating-space-coolant-slowx10",
  ingredients = {
    { type = "fluid", name = "high-pressure-se-space-coolant-hot", amount = 50}, -- 2.5/s
  },
  results = {
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-warm", amount = 4990}, -- -0.2%
  },
...
make_recipe({
  name = "radiating-space-coolant-normalx10",
  ingredients = {
