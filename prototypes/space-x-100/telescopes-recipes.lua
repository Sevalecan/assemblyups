...
make_recipe({
  name = "observation-frame-uvx10",
  ingredients = {
    { data_util.mod_prefix .. "observation-frame-blank", 10 },
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-cold", amount = 80},
  },
  results = {
    { data_util.mod_prefix .. "observation-frame-uv", 10 },
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-hot", amount = 80},
  },
  ...
  icon_size = 64, icon_mipmaps = 1,
  category = "space-observation-uvx10",
  enabled = true,
  always_show_made_in = true,
})

make_recipe({
  name = "observation-frame-visiblex10",
  ingredients = {
    { "observation-frame-blank", 10 },
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-cold", amount = 80},
  },
  results = {
    { name = data_util.mod_prefix .. "observation-frame-visible", amount = 10 },
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-hot", amount = 80},
  },
  ...
  icon_size = 64, icon_mipmaps = 1,
  category = "space-observation-visiblex10",
  enabled = true,
  always_show_made_in = true,
})

make_recipe({
  name = "observation-frame-infraredx10",
  ingredients = {
    { data_util.mod_prefix .. "observation-frame-blank", 10 },
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-cold", amount = 60},
  },
  results = {
    { data_util.mod_prefix .. "observation-frame-infrared", 10 },
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-hot", amount = 60},
  },
  ...
  icon_size = 64, icon_mipmaps = 1,
  category = "space-observation-infraredx10",
  enabled = true,
  always_show_made_in = true,
})
