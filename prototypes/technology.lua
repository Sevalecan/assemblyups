...
data:extend(
{
  ...
  },
  {
    ...
    effects =
    {
      ...
      {
        type = "unlock-recipe",
        recipe = "low-density-structure-v2"
      },
      {
        type = "unlock-recipe",
        recipe = "low-density-structure-X100"
      },
    },
...
if mods["DeepMineALT"] then
    ...
    effects =
    {
      ...
      {
        type = "unlock-recipe",
        recipe = "centrifugeX100"
      },
      {
        type = "unlock-recipe",
        recipe = "centrifugeX500"
      },
      {
        type = "unlock-recipe",
        recipe = "centrifugeX1000"
      },
      {
        type = "unlock-recipe",
        recipe = "deep-miner-mk4-X10"
      },
      {
        type = "unlock-recipe",
