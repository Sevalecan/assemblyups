...
data:extend(
  {
    ...
    {
      type = "recipe",
      name = "angelsore1-crushed-processingx10",
      category = "ore-sortingx10",
      ...
      normal = {
        ingredients = {{type = "item", name = "angels-ore1-crushed", amount = 40}},
        results = {
    ...
    {
      type = "recipe",
      name = "angelsore2-crushed-processingx10",
      category = "ore-sortingx10",
      subgroup = "ore-sorting-t1",
      energy_required = 1,
      enabled = true,
    ...
    {
      type = "recipe",
      name = "angelsore3-crushed-processingx10",
      category = "ore-sortingx10",
      subgroup = "ore-sorting-t1",
      energy_required = 1,
      enabled = true,
    ...
    {
      type = "recipe",
      name = "angelsore4-crushed-processingx10",
      category = "ore-sortingx10",
      subgroup = "ore-sorting-t1",
      energy_required = 1,
      enabled = true,
    ...
    {
      type = "recipe",
      name = "angelsore5-crushed-processingx10",
      category = "ore-sortingx10",
      subgroup = "ore-sorting-t1",
      energy_required = 1,
      enabled = true,
    ...
    {
      type = "recipe",
      name = "angelsore6-crushed-processingx10",
      category = "ore-sortingx10",
      subgroup = "ore-sorting-t1",
      energy_required = 1,
      enabled = true,
