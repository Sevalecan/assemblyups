...
local astrometric_target_animation_speed = 0.001
...
local gravimetric_target_animation_speed = 0.001
...
data:extend({
  {
    ...
    minable = {hardness = 0.2, mining_time = 1, result = "space-astrometrics-laboratoryx10"},
    max_health = 700,
    corpse = "big-remnants",
    ...
    crafting_categories = {"space-astrometricsx10"},
  ...
  },
  {
    ...
    se_allow_in_space = true,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 1, result = "space-gravimetrics-laboratoryx10"},
    max_health = 700,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    alert_icon_shift = util.by_pixel(0, -12),
    ...
    crafting_categories = {"space-gravimetricsx10", "arcospherex10"},
