...
make_recipe({
  name = "observation-frame-uvx100",
  ingredients = {
    { data_util.mod_prefix .. "observation-frame-blank", 100 },
    { type = "fluid", name = "high-pressure-se-space-coolant-cold", amount = 8},
  },
  results = {
    { data_util.mod_prefix .. "observation-frame-uv", 100 },
    { type = "fluid", name = "high-pressure-se-space-coolant-hot", amount = 8},
  },
  ...
  icon_size = 64, icon_mipmaps = 1,
  category = "space-observation-uvx100",
  enabled = true,
  always_show_made_in = true,
})

make_recipe({
  name = "observation-frame-visiblex100",
  ingredients = {
    { data_util.mod_prefix .. "observation-frame-blank", 100 },
    { type = "fluid", name = "high-pressure-se-space-coolant-cold", amount = 8},
  },
  results = {
    { data_util.mod_prefix .. "observation-frame-visible", 10 },
    { type = "fluid", name = "high-pressure-se-space-coolant-hot", amount = 8},
  },
  ...
  icon_size = 64, icon_mipmaps = 1,
  category = "space-observation-visiblex100",
  enabled = true,
  always_show_made_in = true,
})

make_recipe({
  name = "observation-frame-infraredx100",
  ingredients = {
    { data_util.mod_prefix .. "observation-frame-blank", 100 },
    { type = "fluid", name = "high-pressure-se-space-coolant-cold", amount = 6},
  },
  results = {
    { data_util.mod_prefix .. "observation-frame-infrared", 100 },
    { type = "fluid", name = "high-pressure-se-space-coolant-hot", amount = 6},
  },
  ...
  icon_size = 64, icon_mipmaps = 1,
  category = "space-observation-infraredx100",
  enabled = true,
  always_show_made_in = true,
})
