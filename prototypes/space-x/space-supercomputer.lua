...
data:extend({
  {
    ...
    minable = { mining_time = 0.1, result = "space-supercomputer-1x10"},
    ...
    crafting_categories = {"space-supercomputing-1x10"},
...

  {
    ...
    se_allow_in_space = true,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "space-supercomputer-2x10"},
    fast_replaceable_group = data_util.mod_prefix .. "space-supercomputer",
    ...
    crafting_categories = {"space-supercomputing-1x10", "space-supercomputing-2x10"},
  ...
  },
  {
    ...
    se_allow_in_space = true,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "space-supercomputer-3x10"},
    fast_replaceable_group = data_util.mod_prefix .. "space-supercomputer",
    ...
    crafting_categories = {"space-supercomputing-1x10", "space-supercomputing-2x10", "space-supercomputing-3x10"},
