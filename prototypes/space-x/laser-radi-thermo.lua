...
data:extend({
  {
    ...
    minable = {mining_time = 0.2, result = "space-laser-laboratoryx10"},
    max_health = 1200,
    corpse = "big-remnants",
    ...
    crafting_categories = {"space-laserx10"},
  ...
  },
  {
    ...
    se_allow_in_space = true,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "space-radiation-laboratoryx10"},
    max_health = 1200,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    alert_icon_shift = util.by_pixel(0, -12),
    ...
    crafting_categories = {"space-radiationx10", "centrifuging"},
  ...
  },
  {
    ...
    se_allow_in_space = true,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "space-thermodynamics-laboratoryx10"},
    max_health = 1200,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    alert_icon_shift = util.by_pixel(0, -12),
    ...
    crafting_categories = {"space-thermodynamicsx10", "SX10"},
