...
data:extend({
  {
    ...
    minable = {mining_time = 0.1, result = "space-telescopex100"},
    max_health = 500,
    corpse = "big-remnants",
    ...
    crafting_categories = {"space-observation-visiblex100", "space-observation-uvx100", "space-observation-infraredx100"},
