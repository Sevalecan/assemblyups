...
-- making data cell
make_recipe({
  name = "data-storage-substratex10",
  ingredients = {
    { "glass", 3 * recipe_amount },
    { "iron-plate", 6 * recipe_amount }
  },
  results = {
    { data_util.mod_prefix .. "data-storage-substrate", recipe_amount},
  ...
  crafting_categories = {"space-manufacturing",}, --"science-packs-10-crafting"},
  enabled = true,
...
make_recipe({
  name = "empty-datax10",
  ingredients = {
    { "advanced-circuit", 3 * recipe_amount },
    { "copper-plate", 6 * recipe_amount },
    { data_util.mod_prefix .. "data-storage-substrate-cleaned", 4 * recipe_amount }
  },
  results = {
...
make_recipe({
  name = "space-mirrorx10",
  ingredients = {
    { name = "glass", amount = 60},
    { name = "steel-plate", amount = 30},
    { name = "low-density-structure", amount = 10},
    { name = data_util.mod_prefix .. "heat-shielding", amount = 10},
    { type = "fluid", name = "lubricant", amount = 100},
    { type = "fluid", name = data_util.mod_prefix .."chemical-gel", amount = 10},
  },
  results = {
    { name = data_util.mod_prefix.."space-mirror", amount = 10 },
...
make_recipe({
  name = "space-mirror-alternatex10",
  ingredients = {
    { name = "glass", amount = 20},
    { name = data_util.mod_prefix.."iridium-plate", amount = 20},
    { name = "low-density-structure", amount = 10},
    { type = "fluid", name = "lubricant", amount = 50},
    { type = "fluid", name = data_util.mod_prefix.."chemical-gel", amount = 50},
  },
  results = {
    { name = data_util.mod_prefix.."space-mirror", amount = 10 },
...
make_recipe({
  name = "observation-frame-blankx10",
  ingredients = {
    { name = "coal", amount = 10},
    { name = "glass", amount = 10},
    { name = "steel-plate", amount = 10},
    { type = "fluid", name = "light-oil", amount = 100},
  },
  results = {
    { name = data_util.mod_prefix.."observation-frame-blank", amount = 50 },
  },
  energy_required = 5,
  category = "space-manufacturing",
  icons = data_util.sub_icons("__space-exploration-graphics__/graphics/icons/observation-frame-blank.png"),
...
make_recipe({
  name = "chemical-gelx10",
  ingredients = {
    { type = "fluid", name = data_util.mod_prefix .. "space-water", amount = 100},
    { type = "fluid", name = "high-pressure-petroleum-gas", amount = 10},
  },
  results = {
    { type="fluid", name = data_util.mod_prefix .. "chemical-gel", amount = 200},
  },
  energy_required = 10,
  category = "space-manufacturing",
...
make_recipe({
  name = "nano-engineering-datax10",
  ingredients = {
    { name = data_util.mod_prefix .. "nanomaterial", amount = 10, catalyst_amount = 10},
    { type = "fluid", name = data_util.mod_prefix .. "particle-stream", amount = 500},
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-supercooled", amount = 250},
    { name = data_util.mod_prefix .. "empty-data", amount=10},
  },
  results = {
    { name = data_util.mod_prefix .. "nano-engineering-data", amount=10},
    { name = data_util.mod_prefix .. "nanomaterial", amount_min = 10, amount_max = 10, probability = 0.05},
    { name = data_util.mod_prefix .. "heat-shielding", amount_min = 10, amount_max = 10, probability = 0.05},
    { name = "low-density-structure", amount_min = 10, amount_max = 10, probability = 0.05},
    { name = data_util.mod_prefix .. "superconductive-cable", amount_min = 10, amount_max = 10, probability = 0.05},
    { name = data_util.mod_prefix .. "scrap", amount_min = 10, amount_max = 10, probability = 0.05},
    { name = data_util.mod_prefix .. "contaminated-scrap", amount_min = 10, amount_max = 01, probability = 0.05},
    { type = "fluid", name = data_util.mod_prefix .. "space-coolant-hot", amount = 250},
  },
  energy_required = 60,
