data:extend({
 ...
 --item 
  ...
  --entity
  {
    ...
    minable = {mining_time = 0.1, result = "chemical-plantv2"},
    max_health = 300,
    ...
    energy_usage = "5MW",
    crafting_categories = {"chemistry-10"},
