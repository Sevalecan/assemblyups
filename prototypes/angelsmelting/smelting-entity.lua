...
data:extend(
  {
    ...
    --BLAST FURNACE
    {
      ...
      enabled = true,
      ingredients = {
        {type = "item", name = "blast-furnace", amount = 10}
      },
      result = "blast-furnacex10"
    },
    {
      type = "recipe",
      ...
      enabled = true,
      ingredients = {
        {type = "item", name = "blast-furnace-2", amount = 10}
      },
      result = "blast-furnace-2x10"
    },
    {
      type = "recipe",
      ...
      enabled = true,
      ingredients = {
        {type = "item", name = "blast-furnace-3", amount = 10}
      },
      result = "blast-furnace-3x10"
    },
    {
      type = "recipe",
      ...
      enabled = true,
      ingredients = {
        {type = "item", name = "blast-furnace-4", amount = 10}
      },
      result = "blast-furnace-4x10"
    },
    --CHEMICAL FURNACE
    {
      type = "recipe",
