...
data:extend({
  ...
  },
  {
    ...
    energy_required = 2.5,
    enabled = true,
    ingredients = {{type = "item", name = "angels-ore3-crushed", amount = 295}},
    results = {{"copper-plate", 200}},
  },
  {
    type = "recipe",
    name = "angelsore1-crushed-smeltingx100",
    category = "Smelting-X100",
    energy_required = 2.5,
    enabled = true,
  ...
  },
  {
    ...
    energy_required = 2,
    enabled = true,
    ingredients = {{ type = "item", name = "angels-ore3-crushed", amount = 1475}},
  ...
  },
{
    ...
    energy_required = 1,
    enabled = true,
    ingredients = {{ type = "item", name = "angels-ore3-crushed", amount = 2900}},
