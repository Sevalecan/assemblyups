...
data:extend(
{
  ...
  --Entity
    ...
    type = "assembling-machine",
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "washer-chamber-X100"},
		max_health = 300,
		corpse = "big-remnants",
		...
		crafting_categories = {"washing-chamber-X100","washing-chamber-X10",},
		energy_usage = "110MW",
        ingredient_count = 4,
        crafting_speed = 6,
