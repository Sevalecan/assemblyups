...
data:extend(
{
  ...
  {
    type = "item",
    name = "purification-chamber-X100",
    icon = "__NPUtils__/graphics/icon/purification-chamber-icon.png",
	icon_size = 64,
    --flags = {"goes-to-quickbar"},
    subgroup = "n-orepro",
    order = "a",
    place_result = "purification-chamber-X100",
    stack_size = 20
  },
  --Recipe
    {
    ...
    ingredients = 
    {
      {"purification-chamber-X10", 10},
	  {"electronic-circuit", 50}
    },
    result = "purification-chamber-X100"
  },
  --Technology
  ...
  --Entity
    ...
    minable = {mining_time = 1, result = "purification-chamber-X100"},
    max_health = 200,
    corpse = "medium-remnants",
	resistances = {{type = "fire",percent = 80}},
    collision_box = {{-1.2, -1.2}, {1.2, 1.2}},
	selection_box = {{-1.5, -1.5}, {1.5, 1.5}},
    crafting_categories = {"purrification-chamber-X100","purrification-chamber-X10",},
    energy_usage = "50MW",
    ingredient_count = 4,
    crafting_speed = 4.5,
