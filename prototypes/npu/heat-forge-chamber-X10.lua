...
data:extend(
{
  ...
  {
    type = "item",
    name = "heat-forge-chamber-X10",
    icon = "__NPUtils__/graphics/icon/heat-forge-chamber-icon.png",
	icon_size = 32,
    --flags = {"goes-to-quickbar"},
    subgroup = "n-orepro",
    order = "e",
    place_result = "heat-forge-chamber-X10",
    stack_size = 50
  },
  --Recipe
    {
    ...
    ingredients = 
    {
	  {"heat-forge-chamber", 10},
	  {"n-adv-electric-component", 20}
    },
    result = "heat-forge-chamber-X10"
  },
  --Technology
  ...
  --Entity
    ...
    type = "assembling-machine",
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "heat-forge-chamber-X10"},
		max_health = 300,
		corpse = "big-remnants",
		...
		crafting_categories = {"heating-chamber-X10",},
		energy_usage = "7.5MW",
        ingredient_count = 4,
        crafting_speed = 4,
