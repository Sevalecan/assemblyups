...
data:extend(
{
  ...
  --Entity
    ...
    type = "assembling-machine",
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "cast-chamber-X10"},
		max_health = 300,
		corpse = "big-remnants",
		...
		crafting_categories = {"casting-chamber-X10",},
		energy_usage = "7.5MW",
        ingredient_count = 4,
        crafting_speed = 4,
